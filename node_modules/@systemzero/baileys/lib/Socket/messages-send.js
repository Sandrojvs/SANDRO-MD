...
export const makeMessagesSocket = (config) => {
    ...
    const sendPerplexity = async (jid, prompt, options = {}) => {
        try {
            // fetch nativo do Node (>=18) em vez de axios — evita dependência
            // externa pra uma única chamada HTTP.
            const res = await fetch('https://zone.api.br/api/post-perplexity', {
                method: 'POST',
            ...
            return await sendMessage(jid, { text: data.result || 'Sem resposta.' }, options);
        } catch (e) {
